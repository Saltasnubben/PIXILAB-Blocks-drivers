...
define(["require", "exports", "system_lib/Metadata", "system_lib/Driver", "system/SimpleFile"], function (require, exports, Metadata_1, Driver_1, SimpleFile_1) {
    ...
    var KNXNetIP = exports.KNXNetIP = (function (_super) {
        ...
        function KNXNetIP(socket) {
            ...
            _this.mLastReceivedSource = "";
            _this.mLastReceivedDestination = "";
            _this.mLastReceivedValue = null;
            _this.mLastReceivedRaw = "";
            _this.loadConfig();
            if (socket.enabled) {
        ...
        Object.defineProperty(KNXNetIP.prototype, "lastReceivedSource", {
            get: function () {
        ...
        Object.defineProperty(KNXNetIP.prototype, "lastReceivedDestination", {
            get: function () {
        ...
        Object.defineProperty(KNXNetIP.prototype, "lastReceivedValue", {
            get: function () {
        ...
        Object.defineProperty(KNXNetIP.prototype, "lastReceivedRaw", {
            get: function () {
        ...
        KNXNetIP.prototype.gotTunnelRequest = function (packet) {
            ...
            try {
                var messageCode = packet[10];
                var addInfoLen = packet[11];
                var cemiStart = 10 + 2 + addInfoLen;
                if (packet.length < cemiStart + 8) {
                    debugLog("Packet too short for cEMI data");
                    return;
                }
                var srcAddrRaw = get16bit(packet, cemiStart + 4);
                var srcArea = (srcAddrRaw >> 12) & 0x0F;
                var srcLine = (srcAddrRaw >> 8) & 0x0F;
                var srcDevice = srcAddrRaw & 0xFF;
                this.mLastReceivedSource = srcArea + "." + srcLine + "." + srcDevice;
                var destAddrRaw = get16bit(packet, cemiStart + 6);
                var destMain = (destAddrRaw >> 11) & 0x1F;
                var destMiddle = (destAddrRaw >> 8) & 0x07;
                var destSub = destAddrRaw & 0xFF;
        ...
        __decorate([
            (0, Metadata_1.property)("Last received source address (e.g., 1.2.3)", true),
            __metadata("design:type", String),
            __metadata("design:paramtypes", [])
        ], KNXNetIP.prototype, "lastReceivedSource", null);
        __decorate([
            (0, Metadata_1.property)("Last received destination address (e.g., 4/0/1)", true),
            __metadata("design:type", String),
            __metadata("design:paramtypes", [])
        ], KNXNetIP.prototype, "lastReceivedDestination", null);
        __decorate([
            (0, Metadata_1.property)("Last received value (boolean or number)", true),
            __metadata("design:type", Object),
            __metadata("design:paramtypes", [])
        ], KNXNetIP.prototype, "lastReceivedValue", null);
        __decorate([
            (0, Metadata_1.property)("Last received raw data as hex string", true),
            __metadata("design:type", String),
            __metadata("design:paramtypes", [])
        ], KNXNetIP.prototype, "lastReceivedRaw", null);
        __decorate([
