    ...
    <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
      ...
      <div className="flex border-b border-gray-200 bg-gray-50">
        ...
        <div className="flex-1 flex">
          {days.map((day, index) => (
            <div
              key={day.toISOString()}
              className={`flex-1 px-2 py-3 text-center text-sm border-r border-gray-100 last:border-r-0 ${
      ...
      {crew.length > 0 && bookings.length === 0 && (
        <div className="p-8 text-center border-t border-gray-100">
          ...
          <p className="text-gray-500">Inga bokningar hittades för vald period.</p>
        </div>
      )}
    </div>
  );
